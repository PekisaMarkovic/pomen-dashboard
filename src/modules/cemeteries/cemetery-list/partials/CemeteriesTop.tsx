...
const CemeteriesTop = () => {
  ...
  const handleAddNew = useCallback(() => {
    dispatch(setModal(ModalEnums.ADD_CEMETERY))
  }, [])
  ...
  return (
    <div className="mb-6 flex gap-x-6 gap-y-4 flex-wrap">
      ...
      <div className="ml-auto">
        <MainButton text={t('g:button.addCemetery')} variant="contained" size="medium" onClick={handleAddNew} />
      </div>
    </div>
  )
}

export default CemeteriesTop
