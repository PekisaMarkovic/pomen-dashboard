...
interface LeadsTableStatusProps {
  status: LeadStatusEnums
}

const LeadsTableStatus = ({ status }: LeadsTableStatusProps) => {
  const { t } = useTranslation(['leads'])

  const text = t(`leads:leads-status.${status}`)

  switch (status) {
    case LeadStatusEnums.NEW:
      return (
    ...
    case LeadStatusEnums.CONVERTED:
      return (
    ...
    case LeadStatusEnums.IN_PROGRESS:
      return (
    ...
    case LeadStatusEnums.DISCARDED:
      return (
...
export default LeadsTableStatus
