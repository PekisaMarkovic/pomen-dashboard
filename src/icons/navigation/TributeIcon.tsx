const TributeIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg fill="#64748B" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g strokeWidth={0} />
